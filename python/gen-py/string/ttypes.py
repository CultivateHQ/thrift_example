...
all_structs.append(TString)
TString.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'val', 'UTF8', None, ),  # 1
    (2, TType.MAP, 'val_map', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 2
    (3, TType.SET, 'val_set', (TType.STRING, 'UTF8', False), None, ),  # 3
    (4, TType.LIST, 'val_list', (TType.STRING, 'UTF8', False), None, ),  # 4
)
