...
TStruct.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'val', [Val, None], None, ),  # 1
    (2, TType.MAP, 'val_map', (TType.STRUCT, [Val, None], TType.STRUCT, [Val, None], False), None, ),  # 2
    (3, TType.SET, 'val_set', (TType.STRUCT, [Val, None], False), None, ),  # 3
    (4, TType.LIST, 'val_list', (TType.STRUCT, [Val, None], False), None, ),  # 4
)
