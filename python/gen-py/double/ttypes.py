...
class Double(object):
    ...
    def write(self, oprot):
        ...
        if self.val_map is not None:
            ...
            oprot.writeMapBegin(TType.DOUBLE, TType.DOUBLE, len(self.val_map))
            for kiter19, viter20 in self.val_map.items():
                oprot.writeDouble(kiter19)
                oprot.writeDouble(viter20)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.val_set is not None:
            oprot.writeFieldBegin('val_set', TType.SET, 3)
            oprot.writeSetBegin(TType.DOUBLE, len(self.val_set))
            for iter21 in self.val_set:
                oprot.writeDouble(iter21)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        if self.val_list is not None:
            oprot.writeFieldBegin('val_list', TType.LIST, 4)
            oprot.writeListBegin(TType.DOUBLE, len(self.val_list))
...
all_structs.append(Double)
Double.thrift_spec = (
    None,  # 0
    (1, TType.DOUBLE, 'val', None, None, ),  # 1
    (2, TType.MAP, 'val_map', (TType.DOUBLE, None, TType.DOUBLE, None, False), None, ),  # 2
    (3, TType.SET, 'val_set', (TType.DOUBLE, None, False), None, ),  # 3
    (4, TType.LIST, 'val_list', (TType.DOUBLE, None, False), None, ),  # 4
)
