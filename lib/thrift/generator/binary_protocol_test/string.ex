defmodule(Thrift.Generator.BinaryProtocolTest.String) do
  _ = "Auto-generated Thrift struct string.String"
  _ = "1: string val"
  _ = "2: map<string,string> val_map"
  _ = "3: set<string> val_set"
  _ = "4: list<string> val_list"
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Thrift.Generator.BinaryProtocolTest.String{})
    end
    defp(deserialize(<<0, rest::binary>>, %Thrift.Generator.BinaryProtocolTest.String{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Thrift.Generator.BinaryProtocolTest.String{val: val, val_map: val_map, val_set: val_set, val_list: val_list})) do
      [case(val) do
        nil ->
          <<>>
        _ ->
