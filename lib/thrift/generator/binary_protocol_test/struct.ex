defmodule(Thrift.Generator.BinaryProtocolTest.Struct) do
  _ = "Auto-generated Thrift struct struct.Struct"
  _ = "1: struct.Val val"
  _ = "2: map<struct.Val,struct.Val> val_map"
  _ = "3: set<struct.Val> val_set"
  _ = "4: list<struct.Val> val_list"
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Thrift.Generator.BinaryProtocolTest.Struct{})
    end
    defp(deserialize(<<0, rest::binary>>, %Thrift.Generator.BinaryProtocolTest.Struct{} = acc)) do
      {acc, rest}
    end
    defp(deserialize(<<12, 1::16-signed, rest::binary>>, acc)) do
      case(Elixir.Thrift.Generator.BinaryProtocolTest.Val.BinaryProtocol.deserialize(rest)) do
        {value, rest} ->
    ...
    def(serialize(%Thrift.Generator.BinaryProtocolTest.Struct{val: val, val_map: val_map, val_set: val_set, val_list: val_list})) do
      [case(val) do
        nil ->
          <<>>
        _ ->
          [<<12, 1::16-signed>> | Thrift.Generator.BinaryProtocolTest.Val.serialize(val)]
      end, case(val_map) do
        nil ->
          <<>>
        _ ->
          [<<13, 2::16-signed, 12, 12, Enum.count(val_map)::32-signed>> | for({k, v} <- val_map) do
            [Thrift.Generator.BinaryProtocolTest.Val.serialize(k) | Thrift.Generator.BinaryProtocolTest.Val.serialize(v)]
          end]
      end, case(val_set) do
        nil ->
          <<>>
        _ ->
          [<<14, 3::16-signed, 12, Enum.count(val_set)::32-signed>> | for(e <- val_set) do
            Thrift.Generator.BinaryProtocolTest.Val.serialize(e)
          end]
